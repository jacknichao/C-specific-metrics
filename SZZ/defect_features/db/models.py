...
class CommitMeta(Base):
    ...
    author_email = Column(String(512),default=None)
    commit_message = Column(TEXT, default=None)
...
class PurposeFeatures(Base):
    ...
    fix_by = Column(LONGTEXT, default=None) # fix by which commit or commits
    find_interval = Column(Integer,default=None) #
    fixes = Column(LONGTEXT, default=None) # corrective commit fix which commit or commits
    bug_fix_files = Column(LONGTEXT, default=None) # bug_fix file 列表
    fix_file_num = Column(Integer,default=0) 
    buggy_lines = Column(LONGTEXT,default=None) # data type {file1:[line1,line2],file2:[line1,line2]...}
    clean_lines = Column(LONGTEXT, default=None)
    ...
    rules = Column(LONGTEXT,default=None) # rules break
