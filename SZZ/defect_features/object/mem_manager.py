...
class MemManager(object):
    ...
    def __init__(self,project):
        ...
        if not os.path.isdir('/data/xiaodanxu/data/' + self.project):
            os.mkdir('/data/xiaodanxu/data/' + self.project)
        else:
            shutil.rmtree('/data/xiaodanxu/data/' + self.project)
            os.mkdir('/data/xiaodanxu/data/' + self.project)
        if not os.path.isdir('/data/xiaodanxu/data/' + self.project + '/parent_file_stats'):
            os.mkdir('/data/xiaodanxu/data/' + self.project + '/parent_file_stats')
        self.basic_path = '/data/xiaodanxu/data/' + self.project + '/parent_file_stats/'
        self.in_mem = dict()
    ...
    def copy_stats(self,parent_id,commit_id):
        if parent_id not in self.in_mem:
            self.get(parent_id)
